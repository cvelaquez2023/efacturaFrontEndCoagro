...
export const PATH_AS_PAGES = {
  ...
  //Seguridad
  documento: {
    withSlash: `/${modulo_AS}/${documentoPage}`,
    onlyPath: documentoPage,
  },
  crearInvalidacion: {
    withSlash: `/${modulo_AS}/${crearInvalidacionPage}`,
    onlyPath: crearInvalidacionPage,
  },
  listarInvalidacion: {
    withSlash: `/${modulo_AS}/${listarInvalidacionPage}`,
    onlyPath: listarInvalidacionPage,
  },
  listarDte: {
    withSlash: `/${modulo_AS}/${listarDtePage}`,
    onlyPath: listarDtePage,
  },
};
