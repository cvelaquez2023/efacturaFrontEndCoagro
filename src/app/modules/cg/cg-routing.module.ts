...
const routes: Routes = [
  ...
  //Cuentas
  {
    ...
    loadChildren: () =>
      import("../cg/cuenta/cuenta.module").then((m) => m.CuentaModule),
  },
  //Transacciones
  //Consultas
  //Reportes
  ...
  //Admisitracion
  {
    ...
    loadChildren: () =>
      import(
        "../cg/administracion/parametromodulo/parametromodulo.module"
      ).then((m) => m.ParametromoduloModule),
  },
  {
    path: PATHS_CG_PAGES.centroCuenta.onLyPath,
    loadChildren: () =>
      import("../cg/administracion/centrocuenta/centrocuenta.module").then(
        (m) => m.CentrocuentaModule
      ),
  },
];
