...
const MOCK_TAREAS: ITareaProgramada[] = [
	{ nombre: 'Carga nocturna completa', tipoCarga: 'Completa', ultimaEjecucion: '2026-08-09T22:00:00', proximaEjecucion: '2026-08-10T22:00:00', comentario: 'Carga automatica diaria' }
];
const MOCK_BITACORA: IBitacoraCarga[] = [
	{ fecha: '2026-08-09T22:00:00', estado: 'Exitosa', archivo: 'carga_20260809.log' },
	{ fecha: '2026-08-08T22:00:00', estado: 'Exitosa', archivo: 'carga_20260808.log' }
];
...
export class CargaHandheldPageComponent {
	...
	tareasColumns = ['nombre', 'tipoCarga', 'ultimaEjecucion', 'proximaEjecucion'];
	...
	ejecutarCarga(): void {
		...
		this._snotifyService.info('La carga hacia las HandHelds ha finalizado correctamente', { position: SnotifyPosition.rightTop });
	}
}
