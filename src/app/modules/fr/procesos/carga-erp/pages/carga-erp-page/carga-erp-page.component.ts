...
const MOCK_TAREAS: ITareaProgramada[] = [
	{ nombre: 'Carga nocturna al ERP', ultimaEjecucion: '2026-08-09T23:00:00', proximaEjecucion: '2026-08-10T23:00:00', comentario: 'Carga automatica diaria' }
];
const MOCK_BITACORA: IBitacoraCarga[] = [
	{ fecha: '2026-08-09T23:00:00', estado: 'Exitosa', archivo: 'carga_erp_20260809.log' },
	{ fecha: '2026-08-08T23:00:00', estado: 'Exitosa', archivo: 'carga_erp_20260808.log' }
];
...
export class CargaErpPageComponent {
	...
	tareasColumns = ['nombre', 'ultimaEjecucion', 'proximaEjecucion', 'comentario'];
	bitacoraColumns = ['fecha', 'estado', 'archivo'];

	ejecutarCarga(): void {
		this.procesoFinalizado = true;
		this._snotifyService.info('La carga hacia SoftlandERP ha finalizado correctamente', { position: SnotifyPosition.rightTop });
	}
}
