...
const MOCK_DATA: IUbicacionVisita[] = [
	{ cliente: 'CL001', ruta: 'R001', fecha: '2026-08-08', distanciaM: 35, dentroTolerancia: true },
	{ cliente: 'CL003', ruta: 'R002', fecha: '2026-08-09', distanciaM: 210, dentroTolerancia: false }
];
...
export class UbicacionesVisitaPageComponent implements OnInit, AfterViewInit {
	...
	displayedColumns: string[] = ['cliente', 'ruta', 'fecha', 'distanciaM', 'dentroTolerancia'];
	@ViewChild(MatSort) sort!: MatSort;
	@ViewChild(MatPaginator) paginator!: MatPaginator;

	ngOnInit(): void {
		this.filtroForm = this._formBuilder.group({ compania: ['COAGRO2'], fechaDesde: [''], fechaHasta: [''] });
