...
const MOCK_DATA: IDocumentoGenerado[] = [
	{ tipoDocumento: 'Factura', consecutivo: 'FAC0045', cliente: 'CL001', fecha: '2026-08-08', monto: 145.5 },
	{ tipoDocumento: 'Pedido', consecutivo: 'PED0102', cliente: 'CL003', fecha: '2026-08-09', monto: 320.0 }
];
...
export class DocumentosGeneradosFrPageComponent implements OnInit, AfterViewInit {
	constructor(private _formBuilder: FormBuilder) {}

	filtroForm!: FormGroup;
	resultados = new MatTableDataSource<IDocumentoGenerado>();
	displayedColumns: string[] = ['tipoDocumento', 'consecutivo', 'cliente', 'fecha', 'monto'];
