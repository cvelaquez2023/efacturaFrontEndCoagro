...
import {
  IArticuloSugeridoDetalle,
  IAsignacionSugeridoFr,
} from "../../model/asignacion-sugerido-model-interface";
...
const MOCK_ARTICULOS: IArticuloSugeridoDetalle[] = [
  ...
  {
    articulo: "ART002",
    descripcion: "Herbicida Sistemico 1L",
    cantidadAlmacen: 3,
    cantidadDetalle: 1,
  },
];
...
export class DetalleAsignacionSugeridoComponent {
  ...
  clickSave(): void {
    ...
    const data: IAsignacionSugeridoFr = {
      cliente: this.ediData
        ? (this.ediData.cliente as string)
        : (this.clienteField.value as string),
