...
@NgModule({
	declarations: [ControlArchivosActualizacionesPageComponent, AddActualizacionComponent],
	imports: [CommonModule, ControlArchivosActualizacionesRoutingModule, FormsModule, ReactiveFormsModule, AngularMaterialModule]
})
