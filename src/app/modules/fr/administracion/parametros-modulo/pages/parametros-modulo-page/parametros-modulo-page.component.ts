...
const RGB_REGEX =
  /^(25[0-5]|2[0-4]\d|1?\d{1,2}),\s*(25[0-5]|2[0-4]\d|1?\d{1,2}),\s*(25[0-5]|2[0-4]\d|1?\d{1,2})$/;
...
export const CAMPOS_PARAMETROS: ICampoParametro[] = [
  ...
  {
    key: "USA_RUTEO",
    label: "Utilizar Ruteo",
    tab: "General",
    type: "boolean",
  },
  {
    key: "CAM_PAIS",
    label: "Permitir cambiar el país (FRm)",
    tab: "General",
    type: "boolean",
  },
  {
    key: "CAM_LST_PRC",
    label: "Permitir cambiar niveles de precios (FRm)",
    tab: "General",
    type: "boolean",
  },
  {
    key: "CAM_CON_PG",
    label: "Permitir cambiar la condición de pago (FRm)",
    tab: "General",
    type: "boolean",
  },
  {
    key: "CAM_CLA_PED",
    label: "Permitir cambiar la clase (FRm)",
    tab: "General",
    type: "boolean",
  },
  {
    key: "USA_SUG_VENTA",
    label: "Forzar sugerido de venta",
    tab: "General",
    type: "boolean",
  },
  {
  ...
  {
    key: "VERIF_TOMAFISICA",
    label: "Realizar toma física de inventario",
    tab: "General",
    type: "boolean",
  },
  {
    key: "USA_ENVASES",
    label: "Utiliza envases",
    tab: "General",
    type: "boolean",
  },
  {
    key: "SOPORTE_TRASIEGOS",
    label: "Utiliza traspasos",
    tab: "General",
    type: "boolean",
  },
  {
  ...
  {
    key: "CARGA_EN_PROCESO",
    label: "Carga en proceso (indicador de sistema)",
    tab: "General",
    type: "boolean",
    readOnly: true,
  },
  ...
  {
    key: "USA_RUTA_CLIENTE",
    label: "Usar ruta del cliente",
    tab: "Opciones",
    type: "boolean",
  },
  {
    key: "USA_CONSIGNACION",
    label: "Utilizar consignación",
    tab: "Opciones",
    type: "boolean",
  },
  {
    key: "COBRO_MAL_ESTADO",
    label: "Cobrar productos en mal estado",
    tab: "Opciones",
    type: "boolean",
  },
  {
    key: "USA_BODEGA_FA",
    label: "Utilizar bodega de módulo Facturación",
    tab: "Opciones",
    type: "boolean",
  },
  {
    key: "SUG_LOCALIZACION",
    label: "Sugerir localizaciones",
    tab: "Opciones",
    type: "boolean",
  },
  {
    key: "SUGERIR_LOTES",
    label: "Sugerir lotes en pedidos",
    tab: "Opciones",
    type: "boolean",
  },
  {
    key: "VALIDA_LOTE_DEV",
    label: "Validar lote en devolución",
    tab: "Opciones",
    type: "boolean",
  },
  {
    key: "ESQUEMA_DESC",
    label: "Esquema de descuento",
    tab: "Opciones",
    type: "boolean",
  },
  {
    key: "OPT_BUSQ_ARTICULO",
    label: "Opción de búsqueda de artículo",
    tab: "Opciones",
    type: "boolean",
  },
  {
    key: "ENTEROS_PEDIDO",
    label: "Cantidades enteras en pedido",
    tab: "Opciones",
    type: "boolean",
  },
  {
    key: "PED_TEMP",
    label: "Pedidos temporales",
    tab: "Opciones",
    type: "boolean",
  },
  {
    key: "RECAL_PRECIO",
    label: "Recálculo de precios",
    tab: "Opciones",
    type: "boolean",
  },
  {
    key: "VERIF_CARGAS",
    label: "Validar cargas antes de sincronizar",
    tab: "Opciones",
    type: "boolean",
  },
  {
    key: "GENERAR_BITACORA",
    label: "Generar bitácora de sincronización",
    tab: "Opciones",
    type: "boolean",
  },
  {
    key: "HISTORICO_PEDIDOS",
    label: "Cargar histórico de pedidos",
    tab: "Opciones",
    type: "boolean",
  },
  {
  ...
  {
    key: "HISTORICO_FACTURA",
    label: "Cargar histórico de facturas",
    tab: "Opciones",
    type: "boolean",
  },
  {
  ...
  {
    key: "COBROS_FACTURA_CONTADO",
    label: "Cobro facturas contado",
    tab: "Opciones",
    type: "boolean",
  },
  {
    key: "SUBTIPO_RECIBO",
    label:
      "Tipo generación de recibos (1 Consultar, 2 Obligar, 3 Generar Efectivo)",
    tab: "Opciones",
    type: "number",
  ...
  {
    key: "PRONTO_PAGO_TOTALES",
    label: "Descuento pronto pago solo totales",
    tab: "Opciones",
    type: "boolean",
  },
  {
    key: "DESCUENTO_PRONTO_PAGO",
    label: "Aplicar descuento por pronto pago",
    tab: "Opciones",
    type: "boolean",
  },
  {
  ...
  {
    key: "SUBTIPO_NOTACREDITO",
    label: "Subtipo de nota de crédito",
    tab: "Opciones",
    type: "number",
    validators: [Validators.min(0)],
  },
  {
    key: "SUBTIPO_OTROCREDITO",
    label: "Subtipo de otro crédito",
    tab: "Opciones",
    type: "number",
    validators: [Validators.min(0)],
  },
  ...
  {
    key: "ESQUEMA_RESOLUCIONES",
    label: "Esquema de resoluciones (Guatemala)",
    tab: "Opciones",
    type: "boolean",
  },
  {
  ...
  // Rubros de Jornada
  {
    key: "USA_RUBROS_JORNADA",
    label: "Usar rubros de jornada",
  ...
  {
    key: "SINCRO_DESATENDIDA",
    label: "Sincronización desatendida",
    tab: "Sincronización",
    type: "boolean",
  },
...
const CAMPOS_BOOLEAN = new Set(
  CAMPOS_PARAMETROS.filter((c) => c.type === "boolean").map((c) => c.key)
);
...
export class ParametrosModuloPageComponent implements OnInit {
  ...
  errorFor(campo: ICampoParametro): string {
    ...
    if (control.hasError("email") || control.hasError("multiEmail"))
      return "Debe ser un correo válido (debe contener @ y un dominio)";
    if (control.hasError("pattern"))
      return campo.hint ?? "El formato ingresado no es válido";
    if (control.hasError("min"))
      return `El valor mínimo permitido es ${
        (control.getError("min") as { min: number }).min
      }`;
    if (control.hasError("max"))
      return `El valor máximo permitido es ${
        (control.getError("max") as { max: number }).max
      }`;
    if (control.hasError("maxlength"))
      return `Máximo ${
        (control.getError("maxlength") as { requiredLength: number })
          .requiredLength
      } caracteres (límite de la base de datos)`;
  ...
  guardar(): void {
    if (this.parametrosForm.invalid) {
      ...
      this._snotifyService.error(
        "Revise los campos marcados en rojo: el formato ingresado no es válido",
        {
    ...
    if (this.existeConfiguracion) {
        ...
        next: (response) => {
          if (response.success) {
            this._snotifyService.info(
              "Los parámetros del módulo se actualizaron sin problema",
              { position: SnotifyPosition.rightTop }
            );
            this._loadGlobalesRuteo();
          } else {
      ...
      if (!data.CORP_NIT) {
        this._snotifyService.error(
          "El NIT es requerido para crear la configuración inicial",
          { position: SnotifyPosition.rightTop }
        );
        return;
      }
      this._globalesRuteoApiService.createGlobalesRuteo(data).subscribe({
        next: (response) => {
          if (response.success) {
            this._snotifyService.info(
              "Los parámetros del módulo se crearon sin problema",
              { position: SnotifyPosition.rightTop }
            );
            this.existeConfiguracion = true;
            this.parametrosForm.get("CORP_NIT")?.disable();
