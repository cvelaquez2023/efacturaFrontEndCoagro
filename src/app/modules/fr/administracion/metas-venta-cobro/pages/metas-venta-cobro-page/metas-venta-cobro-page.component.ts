...
const MOCK_METAS: IMetaAgente[] = [
	{ agente: 'AG01', ruta: 'R001', mes: 'Agosto 2026', metaVenta: 12000, ventaActual: 8420, metaCobro: 9000, cobroActual: 6100 },
	{ agente: 'AG02', ruta: 'R002', mes: 'Agosto 2026', metaVenta: 9500, ventaActual: 5200, metaCobro: 7000, cobroActual: 4300 },
	{ agente: 'AG04', ruta: 'R003', mes: 'Agosto 2026', metaVenta: 7000, ventaActual: 6800, metaCobro: 5500, cobroActual: 5000 }
];
...
export class MetasVentaCobroPageComponent implements OnInit, AfterViewInit {
	...
	displayedColumns: string[] = ['agente', 'ruta', 'mes', 'metaVenta', 'avanceVenta', 'metaCobro', 'avanceCobro'];
