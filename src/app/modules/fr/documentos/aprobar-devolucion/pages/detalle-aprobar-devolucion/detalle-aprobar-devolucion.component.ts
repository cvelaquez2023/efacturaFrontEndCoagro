...
import { IDevolucionFr, ILineaArticuloDevolucion } from '../../../devoluciones/model/devolucion-fr-model-interface';

const MOCK_LINEAS: ILineaArticuloDevolucion[] = [
	{ articulo: 'ART001', descripcion: 'Fertilizante Foliar 20L', cantidad: 2, lote: 'L-2026-08' },
	{ articulo: 'ART003', descripcion: 'Semilla Maiz Hibrido', cantidad: 1, lote: 'L-2026-08' }
];
