...
export class ExistenciaBodegaApiService {
  ...
  getExistenciaBodega(
    page?: number,
    rows?: number
  ): Observable<IResponse<IResponseConsultarExistenciaBodega[]>> {
    let url = URL_EXISTBODEGA;
    // eslint-disable-next-line @typescript-eslint/restrict-plus-operands
    url = url + "?page=" + page + "&rows=" + rows;
    return this._httpClient.get<
      IResponse<IResponseConsultarExistenciaBodega[]>
    >(url);
  }
  ...
  getall(
    page?: number,
    rows?: number
  ): Observable<IResponse<IResponseConsultarArticuloBodega[]>> {
    let url = URL_EXISTBODEGA;
    // eslint-disable-next-line @typescript-eslint/restrict-plus-operands
    url = url + "?page=" + page + "&rows=" + rows;
    return this._httpClient.get<IResponse<IResponseConsultarArticuloBodega[]>>(
      url
    );
  }

  crearExistenciaBodega(
    existBodega: IResponseCreateExistenciaBodega
  ...
  updateExistenciaBodega(
    id: number,
    existenciaBodega: IResponseCreateExistenciaBodega
  ): Observable<IResponse<number>> {
    // eslint-disable-next-line @typescript-eslint/restrict-plus-operands
