...
export class AddCatClientePageComponent {
  ...
  private _loadFormulario(): void {
    ...
    if (this.editData) {
      ...
      //Facturacion
      this.formCategoriaCliente.controls["categoria"].setValue(
        this.editData.codCategoriaCliente
      );
      this.formCategoriaCliente.controls["categoria"].disable();
      this.formCategoriaCliente.controls["nombre"].setValue(
        this.editData.descripcion
      );
      this.formCategoriaCliente.controls["CtrCtaVentasId"].setValue(
        this.editData.ctrCtaVentasId
      );
      this.formCategoriaCliente.controls["CtrCtaVentasExentaId"].setValue(
        this.editData.ctrCtaVentasExenId
      );
      this.formCategoriaCliente.controls["CtrCtaDevSobreVtaId"].setValue(
        this.editData.ctrCtaDevVentasId
      );
      this.formCategoriaCliente.controls["CtrCtaDescuentaGralId"].setValue(
        this.editData.ctrCtaDescGralId
      );
      this.formCategoriaCliente.controls["CtrCtaCostoVentasId"].setValue(
        this.editData.ctrCtaCostVentId
      );
      this.formCategoriaCliente.controls["CtrCtaDescuentoLineaId"].setValue(
        this.editData.ctrCtaDescLinId
      );
      this.formCategoriaCliente.controls["CtrCtaCostoLineasId"].setValue(
        this.editData.ctrCtaCostLinId
      );
      this.formCategoriaCliente.controls["CtrCtaPagoContadoId"].setValue(
        this.editData.ctrCtaContadoId
      );
      this.formCategoriaCliente.controls["CtrCtaComisionVendedorId"].setValue(
        this.editData.ctrCtaVendComId
      );
      this.formCategoriaCliente.controls["CtrCtaComisionCobradorId"].setValue(
        this.editData.ctrCtaCobrComId
      );
      this.formCategoriaCliente.controls["CtrCtaDescBonificacionId"].setValue(
        this.editData.ctrCtaDescBonifId
      );
      this.formCategoriaCliente.controls["CtrCtaAjustesRedondeoId"].setValue(
        this.editData.ctrCtaAjusteRedondeoId
      );
      //Cuentas Por pagar
      this.formCategoriaCliente.controls["ctrCtaCuentasXCobrar"].setValue(
        this.editData.ctrCtaCCId
      );
      this.formCategoriaCliente.controls["ctrCtaLetraxCobrar"].setValue(
        this.editData.ctrCtaLCId
      );
      this.formCategoriaCliente.controls["ctrCtaProntoPago"].setValue(
        this.editData.ctrCtaProntoPagoCCId
      );
      this.formCategoriaCliente.controls["ctrCtaInteresesdeMora"].setValue(
        this.editData.ctrCtaIntMoraCCId
      );
      this.formCategoriaCliente.controls["ctrCtaRecibos"].setValue(
        this.editData.ctrCtaRecibosCCId
      );
      this.formCategoriaCliente.controls["ctrCtaImpuesto1"].setValue(
        this.editData.ctrCtaImpuesto1CCId
      );
      this.formCategoriaCliente.controls["ctrCtaImpuesto2"].setValue(
        this.editData.ctrCtaImpuesto2CCId
      );
      this.formCategoriaCliente.controls["ctrCtaAnticipos"].setValue(
        this.editData.ctrCtaAnticipoCCId
      );
      this.formCategoriaCliente.controls["ctrCtaCierreDebitos"].setValue(
        this.editData.ctrCtaDebitoCCId
      );
      this.formCategoriaCliente.controls["ctrCtaCierreCreditos"].setValue(
        this.editData.ctrCtaCreditoCCId
      );
      this.formCategoriaCliente.controls["ctrCtaInteresCorriente"].setValue(
        this.editData.ctrCtaIntCorrId
      );
      //Rubros
      this.formCategoriaCliente.controls["Rubro1CC"].setValue(
        this.editData.ctrCtaRubro1CCId
      );
      this.formCategoriaCliente.controls["Rubro2CC"].setValue(
  ...
  onclickCategoria(): void {
    ...
    if (!this.editData) {
      const sendData: IRequestCreateCatCliente = {
        ...
        ctrCtaAjusteRedondeoId: this.CtrCtaAjusteRedondeoIdField
          .value as number,
  ...
  private _edit(categoriaCli: IRequestCreateCatCliente) {
    this._categoriaAoiService
      .updateCategoriaCliente(this.editData.id as number, categoriaCli)
      .subscribe({
        next: (response) => {
          if (response.success) {
            this.formCategoriaCliente.reset();
