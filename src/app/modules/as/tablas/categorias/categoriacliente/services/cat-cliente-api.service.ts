...
import {
  IRequestCreateCatCliente,
  IResponseCatCliente,
} from "./../model/catCliente-api-model-interface";
...
export class CatClienteApiService {
  ...
  getCategoriaCliente(
    page?: number,
    rows?: number
  ): Observable<IResponse<IResponseCatCliente[]>> {
