...
export class AddCatArticuloPageComponent {
  ...
  private _loadFormulario(): void {
    ...
    if (this.editData) {
      ...
      this.formCategoriaArticulo.controls["categoria"].setValue(
        this.editData.codCategoriaArticulo
      );
      // eslint-disable-next-line @typescript-eslint/no-unsafe-member-access
      this.formCategoriaArticulo.controls["nombre"].setValue(
        this.editData.descripcion
      );
      //Tab Generales
      this.formCategoriaArticulo.controls["CtrCtaInventarioId"].setValue(
        this.editData.ctrCtaInventarioId
      );
      this.formCategoriaArticulo.controls["CtrCtaVariacionCostoId"].setValue(
        this.editData.ctrCtaVariaCostoId
      );
      this.formCategoriaArticulo.controls["CtrCtaFaltanteInvFisicoId"].setValue(
        this.editData.ctrCtaFaltInventFisId
      );
      this.formCategoriaArticulo.controls["CtrCtaSobranteInvFisicoId"].setValue(
        this.editData.ctrCtaSobrInventFisId
      );
      this.formCategoriaArticulo.controls["CtrCtaVencimientoId"].setValue(
        this.editData.ctrCtaVencimientoId
      );
      this.formCategoriaArticulo.controls["CtrCtaAjusteId"].setValue(
        this.editData.ctrCtaAjuId
      );
      this.formCategoriaArticulo.controls["CtrCtaAjusteCMVId"].setValue(
        this.editData.ctrCtaAjuCMVId
      );
      //Tab Local
      this.formCategoriaArticulo.controls["CtrCtaVentasLocId"].setValue(
        this.editData.ctrCtaVentasLocId
      );
      this.formCategoriaArticulo.controls["CtrCtaVentasExentasLocId"].setValue(
        this.editData.ctrCtaVentasExenLocId
      );
      this.formCategoriaArticulo.controls["CtrCtaDevSobreVtasLocId"].setValue(
        this.editData.ctrCtaDevVentasLocId
      );
      this.formCategoriaArticulo.controls["CtrCtaDescVentaLocId"].setValue(
        this.editData.ctrCtaDescVentaLocId
      );
      this.formCategoriaArticulo.controls["CtrCtaCostoVentaLocId"].setValue(
        this.editData.ctrCtaCostVentaLocId
      );
      this.formCategoriaArticulo.controls["CtrCtaDescPorLineaLocId"].setValue(
        this.editData.ctrCtaDescLineaLocId
      );
      this.formCategoriaArticulo.controls["CtrCtaCostoDescuentoLocId"].setValue(
        this.editData.ctrCtaCostDescLocId
      );
      this.formCategoriaArticulo.controls["CtrCtaComisionVentasLocId"].setValue(
        this.editData.ctrCtaComsVentaLocId
      );
      this.formCategoriaArticulo.controls["CtrCtaComisionCobroLocId"].setValue(
        this.editData.ctrCtaComsCobroLocId
      );
      this.formCategoriaArticulo.controls["CtrCtaComprasLocId"].setValue(
        this.editData.ctrCtaCompraLocId
      );
      this.formCategoriaArticulo.controls[
        "CtrCtaDesBonificacionLocId"
      ].setValue(this.editData.ctrCtaDescBonifLocId);
      this.formCategoriaArticulo.controls[
        "CtrCtaRetencionAsumCompraLocId"
      ].setValue(this.editData.ctrCtaRetAsumId);
      //Tab Exterior
      this.formCategoriaArticulo.controls["CtrCtaVentasExtId"].setValue(
        this.editData.ctrCtaVentasExpId
      );
      this.formCategoriaArticulo.controls["CtrCtaVentasExentasExtId"].setValue(
        this.editData.ctrCtaVentasExenExpId
      );
      this.formCategoriaArticulo.controls["CtrCtaDevSobreVtasExtId"].setValue(
        this.editData.ctrCtaDevVentasExpId
      );
      this.formCategoriaArticulo.controls["CtrCtaDescVentaExtId"].setValue(
        this.editData.ctrCtaDescVentaExpId
      );
      this.formCategoriaArticulo.controls["CtrCtaCostoVentaExtId"].setValue(
        this.editData.ctrCtaCostVentaExpId
      );
      this.formCategoriaArticulo.controls["CtrCtaDescPorLineaExtId"].setValue(
        this.editData.ctrCtaDescLineaExpId
      );
      this.formCategoriaArticulo.controls["CtrCtaCostoDescuentoExtId"].setValue(
        this.editData.ctrCtaCostDescExpId
      );
      this.formCategoriaArticulo.controls["CtrCtaComisionVentasExtId"].setValue(
        this.editData.ctrCtaComsVentaExpId
      );
      this.formCategoriaArticulo.controls["CtrCtaComisionCobroExtId"].setValue(
        this.editData.ctrCtaComsCobroExpId
      );
      this.formCategoriaArticulo.controls["CtrCtaComprasExtId"].setValue(
        this.editData.ctrCtaCompraImpId
      );
      this.formCategoriaArticulo.controls[
        "CtrCtaDesBonificacionExtId"
      ].setValue(this.editData.ctrCtaDescBonifExpId);
      //Tab Comsuno
      this.formCategoriaArticulo.controls["CtrCtaMaterialEnProcId"].setValue(
        this.editData.ctrCtaMatProcesoId
      );
      this.formCategoriaArticulo.controls["CtrCtaConsumoNormalId"].setValue(
        this.editData.ctrCtaConsNormalId
      );
      this.formCategoriaArticulo.controls["CtrCtaConsumoRetrabajoId"].setValue(
        this.editData.ctrCtaConsRetrabajoId
      );
      this.formCategoriaArticulo.controls["CtrCtaConsumoGastoId"].setValue(
        this.editData.ctrCtaConsGastoId
      );
      this.formCategoriaArticulo.controls[
        "CtrCtaConsumoDesperdicioId"
      ].setValue(this.editData.ctrCtaConsDesperdicId);
      this.formCategoriaArticulo.controls["CtrCtaMaterialAplicadosId"].setValue(
        this.editData.ctrCtaMatAplicadosId
      );
      //Remisiones
      this.formCategoriaArticulo.controls[
        "CtrCtaRemisionesSobranteId"
      ].setValue(this.editData.ctrCtaSobranteRemisId);
      this.formCategoriaArticulo.controls[
        "CtrCtaRemisionesFaltanteId"
      ].setValue(this.editData.ctrCtaFaltanteRemisId);
    }
  }
  onclickCategoria(): void {
    ...
    if (!this.editData) {
      const sendData: ICreateCategoriaArticulo = {
        ...
        ctrCtaFaltInventFisId: this.CtrCtaFaltanteInvFisicoIdFiel
          .value as number,
        ctrCtaSobrInventFisId: this.CtrCtaSobranteInvFisicoIdFiel
          .value as number,
        ...
        ctrCtaVentasExenLocId: this.CtrCtaVentasExentasLocIdFiel
          .value as number,
        ...
        ctrCtaComsVentaLocId: this.CtrCtaComisionVentasLocIdFiel
          .value as number,
        ...
        ctrCtaDescBonifLocId: this.CtrCtaDesBonificacionLocIdFiel
          .value as number,
        CtrCtaRetAsumId: this.CtrCtaRetencionAsumCompraLocIdFiel
          .value as number,
        //Exterior
        ctrCtaVentasExpId: this.CtrCtaVentasExtIdFiel.value as number,
        ctrCtaVentasExenExpId: this.CtrCtaVentasExentasExtIdFiel
          .value as number,
        ...
        ctrCtaComsVentaExpId: this.CtrCtaComisionVentasExtIdFiel
          .value as number,
        ...
        ctrCtaDescBonifExpId: this.CtrCtaDesBonificacionExtIdFiel
          .value as number,
        //Consumo
        ...
        ctrCtaConsRetrabajoId: this.CtrCtaConsumoRetrabajoIdFiel
          .value as number,
        ctrCtaConsGastoId: this.CtrCtaConsumoGastoIdFiel.value as number,
        ctrCtaConsDesperdicId: this.CtrCtaConsumoDesperdicioIdFiel
          .value as number,
        ctrCtaMatAplicadosId: this.CtrCtaMaterialAplicadosIdFiel
          .value as number,
        //Remisiones
        ctrCtaSobranteRemisId: this.CtrCtaRemisionesSobranteIdFiel
          .value as number,
        ctrCtaFaltanteRemisId: this.CtrCtaRemisionesFaltanteIdFiel
          .value as number,
      };
      this._save(sendData);
    } else {
  ...
  private _edit(data: ICreateCategoriaArticulo): void {
    this._categoriaApiService
      .updateCategoria(this.editData.id as number, data)
      .subscribe({
        next: (response) => {
          if (response.success) {
            this.formCategoriaArticulo.reset();
            this._snotifyService.info("El registro se actualizo sin problema", {
