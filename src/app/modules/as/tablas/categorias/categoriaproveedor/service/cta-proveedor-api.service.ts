...
import {
  IRequestCreateCtaProveedor,
  IResponseCtaProveedor,
} from "../model/ctaProveedor-api-model-interface";
...
export class CtaProveedorApiService {
  ...
  getCategoriaProveedor(
    page?: number,
    rows?: number
  ): Observable<IResponse<IResponseCtaProveedor[]>> {
