...
export class AddTipoAnulacionComponent {
  ...
  private _loadFormGroup(): void {
    ...
    if (this.ediData) {
      ...
      this.tipoAnulacionForm.controls["codTipoAnulacion"].setValue(
        this.ediData.codTipoAnulacion
      );
      this.tipoAnulacionForm.controls["codTipoAnulacion"].disable();
      this.tipoAnulacionForm.controls["nombre"].setValue(
  ...
  private _edit(data: IResponseTipoAnulacion) {
    this._tipoAnulacionApiService
      .update(this.ediData.id as number, data)
      .subscribe({
        next: (response) => {
          if (response.success) {
            this.tipoAnulacionForm.reset();
