...
export class AddTipoImpuestoComponent {
  ...
  private _loadFormGroup(): void {
    ...
    if (this.ediData) {
      ...
      this.tipoImpuestoForm.controls["codTipoImpuesto"].setValue(
        this.ediData.codTipoImpuesto
      );
      this.tipoImpuestoForm.controls["codTipoImpuesto"].disable();
      this.tipoImpuestoForm.controls["nombre"].setValue(
