...
export class AddCodimpuestoComponent implements OnInit {
  ...
  private _edit(data: ICreateImpuesto) {
    ...
    this._codigoImpuestoApiService
      .updateImpuesto(this.editData.id as number, data)
      .subscribe({
        next: (response) => {
          if (response.success) {
            this.formCodigoImpuesto.reset();
  ...
  private _loadFormulario(): void {
    ...
    if (this.editData) {
      ...
      this.formCodigoImpuesto.controls["codigo"].setValue(
        this.editData.codImpuesto
      );
      this.formCodigoImpuesto.controls["codigo"].disable();
      this.formCodigoImpuesto.controls["descripcion"].setValue(
        this.editData.descripcion
      );
      this.formCodigoImpuesto.controls["activo"].setValue(this.editData.activo);
      //impuesto1
      this.formCodigoImpuesto.controls["tipoContabImp1"].setValue(
        this.editData.tipoContabImp1
      );
      this.formCodigoImpuesto.controls["contDevImp1"].setValue(
        this.editData.contDevImp1
      );
      this.formCodigoImpuesto.controls["tipoImpuesto"].setValue(
        this.editData.tipoImpuesto
      );
      this.formCodigoImpuesto.controls["impuesto1"].setValue(
        this.editData.impuesto1
      );
      this.formCodigoImpuesto.controls["ctrCtaImp1Id"].setValue(
        this.editData.ctrCtaImp1Id
      );
      this.formCodigoImpuesto.controls["ctrCtaImp1GenVtsId"].setValue(
        this.editData.ctrCtaImp1GenVtsId
      );
      this.formCodigoImpuesto.controls["ctrCtaImp1DesCompId"].setValue(
        this.editData.ctrCtaImp1DesCompId
      );
      this.formCodigoImpuesto.controls["ctrCtaImp1DevCompId"].setValue(
        this.editData.ctrCtaImp1DevCompId
      );
      this.formCodigoImpuesto.controls["ctrCtaImp1DevVentasId"].setValue(
        this.editData.ctrCtaImp1DevVentasId
      );
      //impuesto2
      this.formCodigoImpuesto.controls["tipoContabImp2"].setValue(
        this.editData.tipoContabImp2
      );
      this.formCodigoImpuesto.controls["contDevImp2"].setValue(
        this.editData.contDevImp2
      );
      this.formCodigoImpuesto.controls["usaImpuesto2Cantidad"].setValue(
        this.editData.usaImpuesto2Cantidad
      );
      this.formCodigoImpuesto.controls["impuesto2"].setValue(
        this.editData.impuesto2
      );
      this.formCodigoImpuesto.controls["calculoImp2"].setValue(
        this.editData.calculoImp2
      );
      this.formCodigoImpuesto.controls["ctrCtaImp2Id"].setValue(
        this.editData.ctrCtaImp2Id
      );
      this.formCodigoImpuesto.controls["ctrCtaImp2GenVtsId"].setValue(
        this.editData.ctrCtaImp2GenVtsId
      );
      this.formCodigoImpuesto.controls["ctrCtaImp2DesCompId"].setValue(
        this.editData.ctrCtaImp2DesCompId
      );
      this.formCodigoImpuesto.controls["ctrCtaImp2DevCompId"].setValue(
        this.editData.ctrCtaImp2DevCompId
      );
      this.formCodigoImpuesto.controls["ctrCtaImp2DevVentasId"].setValue(
        this.editData.ctrCtaImp2DevVentasId
      );
    }
  }
