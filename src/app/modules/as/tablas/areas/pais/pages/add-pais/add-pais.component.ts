...
export class AddPaisComponent {
  ...
  private _loadFormGroup(): void {
    ...
    if (this.editData) {
      ...
      this.PaisForm.controls["ctrCtaVentas"].setValue(
        this.editData.ctrCtaVentasId
      );
      this.PaisForm.controls["ctrCtaVentasExenta"].setValue(
        this.editData.ctrCtaVentasExenId
      );
      this.PaisForm.controls["ctrCtaDevSobreVta"].setValue(
        this.editData.ctrCtaDevVentasId
      );
      this.PaisForm.controls["ctrCtaDescuentaGral"].setValue(
        this.editData.ctrCtaDescGralId
      );
      this.PaisForm.controls["ctrCtaCostoVentas"].setValue(
        this.editData.ctrCtaCostoVenId
      );
      this.PaisForm.controls["ctrCtaDescuentoLinea"].setValue(
        this.editData.ctrCtaDescLinId
      );
      this.PaisForm.controls["ctrCtaCostoLineas"].setValue(
        this.editData.ctrCtaCostoLinId
      );
      this.PaisForm.controls["ctrCtaPagoContado"].setValue(
        this.editData.ctrCtaContadoId
      );
      this.PaisForm.controls["ctrCtaGastoComision"].setValue(
        this.editData.ctrCtaGasComId
      );
      this.PaisForm.controls["ctrCtaDescBonificacion"].setValue(
        this.editData.ctrCtaDescBonifId
      );
      this.PaisForm.controls["ctrCtaAjustesRedondeo"].setValue(
        this.editData.ctrCtaAjusteRedondeoId
      );
      //Tab CC
      this.PaisForm.controls["ctrCtaCuentasXCobrar"].setValue(
        this.editData.ctrCtaCCId
      );
      this.PaisForm.controls["ctrCtaLetraxCobrar"].setValue(
        this.editData.ctrCtaLCId
      );
      this.PaisForm.controls["ctrCtaProntoPago"].setValue(
        this.editData.ctrCtaProntoPagoCCId
      );
      this.PaisForm.controls["ctrCtaInteresesdeMora"].setValue(
        this.editData.ctrCtaIntMoraCCId
      );
      this.PaisForm.controls["ctrCtaRecibos"].setValue(
        this.editData.ctrCtaRecibosCCId
      );
      this.PaisForm.controls["ctrCtaImpuesto1"].setValue(
        this.editData.ctrCtaImpuesto1CCId
      );
      this.PaisForm.controls["ctrCtaImpuesto2"].setValue(
        this.editData.ctrCtaImpuesto2CCid
      );
      this.PaisForm.controls["ctrCtaAnticipos"].setValue(
        this.editData.ctrCtaAnticipoCCId
      );
      this.PaisForm.controls["ctrCtaCierreDebitos"].setValue(
        this.editData.ctrCtaDebitoCCId
      );
      this.PaisForm.controls["ctrCtaCierreCreditos"].setValue(
        this.editData.ctrCtaCreditoCCId
      );
      this.PaisForm.controls["ctrCtaInteresCorriente"].setValue(
        this.editData.ctrCtaIntCorrienteId
      );
      //Tab CP
      this.PaisForm.controls["ctrCtaCuentasXPagar"].setValue(
        this.editData.ctrCtoCPId
      );
      this.PaisForm.controls["ctrCtaLetraxPagar"].setValue(
        this.editData.ctrCtaLPId
      );
      this.PaisForm.controls["ctrCtaProntoPagoCP"].setValue(
        this.editData.ctrCtaProntoPagoCPId
      );
      this.PaisForm.controls["ctrCtaComisiones"].setValue(
        this.editData.ctrCtaComisionCPId
      );
      this.PaisForm.controls["ctrCtaImpuesto1CP"].setValue(
        this.editData.ctrCtaImpuesto1CP
      );
      this.PaisForm.controls["ctrCtaImpuesto2CP"].setValue(
        this.editData.ctrCtaImpuesto2CPId
      );
      this.PaisForm.controls["ctrCtaAnticiposCP"].setValue(
        this.editData.ctrCtaAnticipoCPId
      );
      this.PaisForm.controls["ctrCtaCierreDebitosCP"].setValue(
        this.editData.ctrCtaDebitoCPId
      );
      this.PaisForm.controls["ctrCtaCierreCreditosCP"].setValue(
        this.editData.ctrCtaCreditoCPId
      );
      //Tab Otros
      this.PaisForm.controls["Rubro1CC"].setValue(
        this.editData.ctrCtaRubro1CCId
      );
      this.PaisForm.controls["Rubro2CC"].setValue(
        this.editData.ctrCtaRubro2CCId
      );
      this.PaisForm.controls["Rubro1CP"].setValue(
        this.editData.ctrCtaRubro1CPId
      );
      this.PaisForm.controls["Rubro2CP"].setValue(
        this.editData.ctrCtaRubro2CPId
      );
