...
const routes: Routes = [
  ...
  //Seguridad
  {
    ...
    loadChildren: () =>
      import("../as/seguridad/usuario/usuario.module").then(
        (m) => m.UsuarioModule
      ),
  },
  {
    ...
    loadChildren: () =>
      import("../as/seguridad/grupo/grupo.module").then((m) => m.GrupoModule),
  },
  //Tablas/Areas
  {
    path: PATH_AS_PAGES.listarInvalidacion.onlyPath,
    loadChildren: () =>
      import("../as/tablas/areas/pais/pais.module").then((m) => m.PaisModule),
  },
];
