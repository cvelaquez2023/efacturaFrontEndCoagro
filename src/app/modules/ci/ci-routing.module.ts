...
const routes: Routes = [
  ...
  },
  {
    ...
    loadChildren: () =>
      import("../ci/articulo/articulo.module").then((m) => m.ArticuloModule),
  },
  {
    path: PATHS_CI_PAGES.lote.onLypath,
    loadChildren: () =>
      import("../ci/lote/lote.module").then((m) => m.LoteModule),
  },
  {
    path: PATHS_CI_PAGES.paqueteCI.onLypath,
    loadChildren: () =>
      import("../ci/transacciones/paquete/paquete.module").then(
        (m) => m.PaqueteModule
      ),
  },
  {
    ...
    loadChildren: () =>
      import("../ci/transacciones/enlinea/enlinea.module").then(
        (m) => m.EnlineaModule
      ),
  },
  //Administracion

  {
    ...
    loadChildren: () =>
      import("../ci/administracion/consecutivos/consecutivos.module").then(
  ...
  },
  {
    ...
    loadChildren: () =>
      import(
        "../ci/administracion/clasificaciones/clasificaciones.module"
      ).then((m) => m.ClasificacionesModule),
  },
  {
    path: PATHS_CI_PAGES.transaccionesConfigurables.onLypath,
    loadChildren: () =>
      import(
        "../ci/administracion/transacciones-configurables/transacciones-configurables.module"
      ).then((m) => m.TransaccionesConfigurablesModule),
  },
  {
    path: PATHS_CI_PAGES.parametrosModulo.onLyPath,
    loadChildren: () =>
      import(
        "../ci/administracion/parametros-modulo/parametros-modulo.module"
