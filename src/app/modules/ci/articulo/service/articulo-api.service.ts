...
export class ArticuloApiService {
  ...
  getCentroCosto(): Observable<IResponse<IResponseCentroCosto[]>> {
    ...
    return this._httpClient.get<IResponse<IResponseCentroCosto[]>>(
      URL_CENTRO_COSTO
    );
  }
  getCuentaContable(): Observable<IResponse<IResponseCentroCuenta[]>> {
    ...
    return this._httpClient.get<IResponse<IResponseCentroCuenta[]>>(
      URL_CUENTA_CONTABLE
    );
  }
  ...
  getImpuestos(): Observable<IResponse<IResponseTipoImpuesto[]>> {
    ...
    return this._httpClient.get<IResponse<IResponseTipoImpuesto[]>>(
      URL_IMPUESTO
    );
  }
  ...
  getCajaChica(): Observable<IResponse<IResponseCajaChica[]>> {
    return this._httpClient.get<IResponse<IResponseCajaChica[]>>(
      URL_CAJA_CHICA
    );
  }

  getDepartamento(): Observable<IResponse<IResponseDepartamento[]>> {
    return this._httpClient.get<IResponse<IResponseDepartamento[]>>(
      URL_DEPARTAMENTO
    );
  }
  getConcepto(): Observable<IResponse<IResponseConceptoVale[]>> {
    return this._httpClient.get<IResponse<IResponseConceptoVale[]>>(
      URL_CCONCEPTO
    );
  }
  getBeneficiario(): Observable<IResponse<IResponseBeneficiario[]>> {
    return this._httpClient.get<IResponse<IResponseBeneficiario[]>>(
      URL_BENEFICIARIO
    );
  }
  ...
  posDocCp(documento: any): Observable<IResponse<IResponseAsientoLinea[]>> {
    return this._httpClient.post<IResponse<IResponseAsientoLinea[]>>(
      URL_DOC_CP,
      documento
    );
  }
  ...
  posVale(documento: any): Observable<IResponse<IResponseVale[]>> {
    return this._httpClient.post<IResponse<IResponseVale[]>>(
      URL_VALE,
      documento
    );
  }
  ...
  createArticulo(
    articulo: IRequestCreateArticulo
