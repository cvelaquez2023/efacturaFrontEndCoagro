...
export class AddArticuloPageComponent implements OnInit {
  ...
  private _loadCuentaArticulo(): void {
    this._categoriaArticuloApiService
      .getCatArticulo(1, 1000)
      .subscribe((response) => {
  ...
  private _loadUnidadMedida(): void {
    this._unidadMedidaApiService
      .getUnidadMedida(1, 1000)
      .subscribe((response) => {
        if (response && response.success) {
  ...
  private _loadFormGroup(): void {
    ...
    if (this.ediData) {
      ...
      this.formGroup.controls["ventaTarjeta"].setValue(
        this.ediData.ventaTarjeta
      );
      this.formGroup.controls["existenciaMinima"].setValue(
        this.ediData.existenciaMinima
      );
      this.formGroup.controls["existenciaMaxima"].setValue(
        this.ediData.existenciaMaxima
      );
      this.formGroup.controls["existenciaReorden"].setValue(
        this.ediData.puntoDeOrden
      );
      this.formGroup.controls["codBarraVenta"].setValue(
        this.ediData.codigoBarrasVent
      );
      this.formGroup.controls["codBarraDetalle"].setValue(
        this.ediData.codigoBarrasInvt
      );
      //Classificaciones
      ...
      this.formGroup.controls["codArtProveedor"].setValue(
        this.ediData.articuloDelProv
      );
      this.formGroup.controls["ordenMinima"].setValue(this.ediData.ordenMinima);
      this.formGroup.controls["rebastesimineto"].setValue(
        this.ediData.plazoReabast
      );
      this.formGroup.controls["multiploLote"].setValue(
        this.ediData.loteMultiplo
      );
      //Otros
      this.formGroup.controls["conteoCiclico"].setValue(
        this.ediData.frecuenciaConteo
      );
      this.formGroup.controls["bultos"].setValue(this.ediData.bultos);
      this.formGroup.controls["gtn"].setValue(this.ediData.gtn);
      this.formGroup.controls["manufactura"].setValue(
        this.ediData.manufacturador
      );
      //Unidades
      ...
      this.formGroup.controls["almacenamiento"].setValue(
        this.ediData.unidadAlmacenId
      );
      ...
      this.formGroup.controls["multiploDetalle"].setValue(
        this.ediData.factorEmpaque
      );
      this.formGroup.controls["multiploVenta"].setValue(
        this.ediData.factorVenta
      );
      //Impuestos
      this.formGroup.controls["codigoImpuesto"].setValue(
        this.ediData.impuestoId
      );
      this.formGroup.controls["cuenta"].setValue(
        this.ediData.categoriaArticuloId
      );
      //Retenciones
      this.formGroup.controls["retencionVentas"].setValue(
        this.ediData.impuestoId
      );
      this.formGroup.controls["retencionCompras"].setValue(
        this.ediData.impuestoId
      );
      this.formGroup.controls["retencionModelo"].setValue(
        this.ediData.impuestoId
      );
      //Otros
      ...
      this.formGroup.controls["obligaCuarentena"].setValue(
        this.ediData.obligaCuarentena
      );
      this.formGroup.controls["mimimoVidaCompra"].setValue(
        this.ediData.minVidaCompra
      );
      this.formGroup.controls["mimimoVidaConsumo"].setValue(
        this.ediData.minVidaConsumo
      );
      this.formGroup.controls["mimimoVidaVenta"].setValue(
        this.ediData.minVidaVenta
      );
      this.formGroup.controls["vidaUtilPromedio"].setValue(
        this.ediData.vidaUtilPromedio
      );
      this.formGroup.controls["cuarentena"].setValue(
        this.ediData.diasCuarentena
      );
      //usuario
      this.formGroup.controls["usuarioCreacion"].setValue(
        this.ediData.usuarioCreacion
      );
      ...
      this.formGroup.controls["usuarioModificacion"].setValue(
        this.ediData.usuarioModificacion
      );
