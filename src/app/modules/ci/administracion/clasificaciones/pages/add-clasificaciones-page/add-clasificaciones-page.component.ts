import {
  IResponseClasificacion,
  ICreateClasificacion,
} from "./../../services/clasificacion-api-model-interface";
...
export class AddClasificacionesPageComponent {
  ...
  private _loadFormGroup(): void {
    ...
    if (this.editData) {
      ...
      this.claForm.controls["codClasificacion"].setValue(
        this.editData.codClasificacion
      );
      // eslint-disable-next-line @typescript-eslint/no-unsafe-member-access
