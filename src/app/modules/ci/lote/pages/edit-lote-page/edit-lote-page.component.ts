...
export class EditLotePageComponent implements OnInit {
  ...
  private _loadFormulario(): void {
    ...
    this.formLote.controls["perecedero"].setValue(
      this.editData.articulo.perecedero
    );
    this.formLote.controls["perecedero"].disable();
    this.formLote.controls["articulo"].setValue(
      this.editData.articulo.codArticulo
    );
    this.formLote.controls["articulo"].disable();
    this.formLote.controls["descripcion"].setValue(
      this.editData.articulo.descripcion
    );
    this.formLote.controls["descripcion"].disable();
    this.formLote.controls["loteprov"].setValue(this.editData.loteProveedor);
    this.formLote.controls["cantidad"].setValue(
      this.editData.cantidadIngresada
    );
    ...
    this.formLote.controls["fechaCuarentena"].setValue(
      this.editData.fechaCuarentena
    );
    this.formLote.controls["fechaCuarentena"].disable();
    this.formLote.controls["fechaVencimiento"].setValue(
      this.editData.fechaVencimiento
    );
