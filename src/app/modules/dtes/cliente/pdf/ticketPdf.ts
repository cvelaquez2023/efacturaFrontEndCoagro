          ...
          columns: [
            {
              width: "*",
              text: [
                { text: "P/DESC: ", bold: true },
                { text: fmt(p.total / p.cantidad) },
              ],
              fontSize: 6,
            },
            {
...
const buildTotals = (
  ...
  ...(documento.condicionPago !== "1"
    ? buildPagareBlock(receptor, resumen, dte, documento)
    : []),
  ...buildFirmasBlock(),
];
