...
const routes: Routes = [
  ...
  },
  {
    ...
    loadChildren: () =>
      import("../dtes/cliente/cliente.module").then((m) => m.ClienteModule),
  },
  {
    path: PATHS_DTE_PAGES.proveedorDte.onLyPath,
    loadChildren: () =>
      import("../dtes/proveedor/proveedor.module").then(
        (m) => m.ProveedorModule
      ),
  },
  {
    ...
    loadChildren: () =>
      import("../dtes/invalidaciones/invalidaciones.module").then(
        (m) => m.InvalidacionesModule
      ),
  },
  {
    path: PATHS_DTE_PAGES.usuarioDte.onLypath,
    loadChildren: () =>
      import("../dtes/usuarios/usuarios.module").then((m) => m.UsuariosModule),
  },
];
@NgModule({
