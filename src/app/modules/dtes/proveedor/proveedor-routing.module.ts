...
const routes: Routes = [
  ...
  },
  {
    ...
    loadChildren: () =>
      import(
        "../proveedor/sujetoexcluido-provee/sujetoexcluido-provee.module"
      ).then((m) => m.SujetoexcluidoProveeModule),
  },
  {
    path: PATHS_PROVEE_PAGES.invalidacion.onLypath,
    loadChildren: () =>
      import(
        "../proveedor/invalidaciones-provee/invalidaciones-provee.module"
      ).then((m) => m.InvalidacionesProveeModule),
  },
];
@NgModule({
