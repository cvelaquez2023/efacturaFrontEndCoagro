	...
	navigateToPage(name: string): void {
		switch (name) {
			...
			case '_asignacionRutas':
				void this._router.navigateByUrl(PATHS_FR_PAGES.asignacionRutas.withSlash);
				break;
			case '_devoluciones':
				void this._router.navigateByUrl(PATHS_FR_PAGES.devoluciones.withSlash);
				break;
			case '_aprobarDevolucion':
				void this._router.navigateByUrl(PATHS_FR_PAGES.aprobarDevolucion.withSlash);
				break;
			case '_documentosNoCargados':
				void this._router.navigateByUrl(PATHS_FR_PAGES.documentosNoCargados.withSlash);
				break;
			case '_bitacoraSincronizacion':
				void this._router.navigateByUrl(PATHS_FR_PAGES.bitacoraSincronizacion.withSlash);
				break;
			case '_clientesAbandono':
				void this._router.navigateByUrl(PATHS_FR_PAGES.clientesAbandono.withSlash);
				break;
			case '_historicoVisitas':
				void this._router.navigateByUrl(PATHS_FR_PAGES.historicoVisitas.withSlash);
				break;
			case '_ventasConsignacion':
				void this._router.navigateByUrl(PATHS_FR_PAGES.ventasConsignacion.withSlash);
				break;
			case '_documentosGeneradosFr':
				void this._router.navigateByUrl(PATHS_FR_PAGES.documentosGeneradosFr.withSlash);
				break;
			case '_liquidacionAgentes':
				void this._router.navigateByUrl(PATHS_FR_PAGES.liquidacionAgentes.withSlash);
				break;
			case '_visitasDia':
				void this._router.navigateByUrl(PATHS_FR_PAGES.visitasDia.withSlash);
				break;
			case '_ubicacionesVisita':
				void this._router.navigateByUrl(PATHS_FR_PAGES.ubicacionesVisita.withSlash);
				break;
			case '_cargaClientes':
				void this._router.navigateByUrl(PATHS_FR_PAGES.cargaClientes.withSlash);
				break;
			case '_cargaArticulos':
				void this._router.navigateByUrl(PATHS_FR_PAGES.cargaArticulos.withSlash);
				break;
			case '_cargaBodegas':
			...
			case '_configuracionHH':
				void this._router.navigateByUrl(PATHS_FR_PAGES.configuracionHH.withSlash);
				break;
			case '_cargaUbicacionesClientes':
				void this._router.navigateByUrl(PATHS_FR_PAGES.cargaUbicacionesClientes.withSlash);
				break;
			case '_cierreJornada':
			...
			case '_gruposArticulos':
				void this._router.navigateByUrl(PATHS_FR_PAGES.gruposArticulos.withSlash);
				break;
			case '_visitas':
			...
			case '_sugeridosVenta':
				void this._router.navigateByUrl(PATHS_FR_PAGES.sugeridosVenta.withSlash);
				break;
			case '_asignacionSugeridosVenta':
				void this._router.navigateByUrl(PATHS_FR_PAGES.asignacionSugeridosVenta.withSlash);
				break;
			case '_bodegas':
			...
			case '_controlArchivosActualizaciones':
				void this._router.navigateByUrl(PATHS_FR_PAGES.controlArchivosActualizaciones.withSlash);
				break;
			case '_monitoreoDocumentos':
				void this._router.navigateByUrl(PATHS_FR_PAGES.monitoreoDocumentos.withSlash);
				break;
			case '_parametrosModulo':
				void this._router.navigateByUrl(PATHS_FR_PAGES.parametrosModulo.withSlash);
				break;
			case '_dashboardGeneral':
				void this._router.navigateByUrl(PATHS_FR_PAGES.dashboardGeneral.withSlash);
				break;
			case '_metasVentaCobro':
				void this._router.navigateByUrl(PATHS_FR_PAGES.metasVentaCobro.withSlash);
				break;
			case '_acercaDe':
