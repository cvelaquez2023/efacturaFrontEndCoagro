...
const routes: Routes = [
  {
    ...
    children: [
      ...
      },
      {
        ...
        loadChildren: () =>
          import("./modules/ci/ci.module").then((m) => m.CiModule),
      },
      {
        path: PATH_AS_PAGES.onlyPath,
        loadChildren: () =>
          import("./modules/as/as.module").then((m) => m.AsModule),
      },
      {
        path: PATHS_CG_PAGES.moduloCG.onLyPath,
        loadChildren: () =>
          import("./modules/cg/cg.module").then((m) => m.CgModule),
      },
      {
        path: PATHS_DTE_PAGES.moduloDte.onLyPath,
        loadChildren: () =>
          import("./modules/dtes/dtes.module").then((m) => m.DtesModule),
      },
      {
        path: PATHS_PROVEE_PAGES.moduloprovee.onLyPath,
        loadChildren: () =>
          import("./modules/dtes/proveedor/proveedor.module").then(
            (m) => m.ProveedorModule
          ),
      },
      {
        ...
        loadChildren: () =>
          import("./modules/fr/fr.module").then((m) => m.FrModule),
      },
    ],
  },
